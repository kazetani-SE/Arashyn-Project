        ...
        bg-[#070b1ae0] backdrop-blur-2xl bg-background/50">
            <div className="container mx-auto flex items-center justify-between px-6 py-4">
                ...
                <div className="flex items-center gap-3">
                    <button className="text-white/60 px-4 py-2 text-sm">Log in</button>
                    <button className="bg-indigo-500 shadow-[0_0_24px_rgba(99,102,241,0.4)] rounded-xl px-5 py-2 text-sm font-semibold text-white">
                        Get Started
                    </button>
                </div>
            </div>
